...
namespace RateFilms.Infrastructure.Migrations
{
    ...
    [Migration("20231123161927_4.6.1")]
    partial class _461
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ActorDbModelFilmDbModel", b =>
                {
                    ...
                    b.ToTable("ActorDbModelFilmDbModel");
                });

            modelBuilder.Entity("ActorDbModelSeasonDbModel", b =>
                {
                    b.Property<Guid>("ActorsId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ActorDbModelFilmDbModel", b =>
                {
                    b.HasOne("RateFilms.Domain.StorageModels.ActorDbModel", null)
                        .WithMany()
                        .HasForeignKey("ActorsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RateFilms.Domain.StorageModels.FilmDbModel", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ActorDbModelSeasonDbModel", b =>
                {
                    ...
                    b.HasOne("RateFilms.Domain.StorageModels.SeasonDbModel", null)
                        .WithMany()
